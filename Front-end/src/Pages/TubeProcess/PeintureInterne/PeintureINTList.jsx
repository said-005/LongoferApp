    ...
    <div className="container mx-auto px-2 sm:px-4 py-4 md:py-6 mt-4 md:mt-20">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 md:mb-6 gap-2 md:gap-4">
        <div className="text-center md:text-left">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white">Liste des peintures internes </h1>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
            Gestion des peintures internes
          </p>
        </div>
        <Link 
          to={'/peinture_int/AddPeinture_int'} 
        ...
        >
          <span className="hidden sm:inline">+ Nouvelle peinture interne</span>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 shadow-sm overflow-x-auto">
        {data && data.length > 0 ? (
          ...
          <div className="p-6 sm:p-8 text-center text-gray-500 dark:text-gray-400">
            Aucune peinture interne trouvée
          </div>
        )}
      </div>
    </div>
