...
return (
  <div className="p-6 max-w-6xl mx-auto bg-white dark:bg-gray-900 rounded-lg shadow-md dark:shadow-gray-800/50 mt-30">
    <h1 className="text-2xl font-bold mb-8 text-center text-gray-800 dark:text-blue-100">Formulaire d'Emmanchement</h1>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="dark:text-blue-100">Code Emmanchement</FormLabel>
                <FormControl>
                  <Input
