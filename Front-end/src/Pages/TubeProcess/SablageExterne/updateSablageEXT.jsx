...
if (isSablageEXTError) {
  return (
    <div className="flex justify-center items-center h-64">
      <span className="text-red-500 dark:text-red-400">Erreur lors du chargement du sablage externe</span>
    </div>
  );
}
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="dark:text-blue-100">Référence Sablage Externe</FormLabel>
                <FormControl>
                  <Input
                    placeholder="Entrez une Référence de sablage externe"
                    {...field}
                    className="dark:bg-gray-800 dark:border-gray-700 dark:text-blue-100 dark:placeholder:text-blue-200/50"
                  />
                </FormControl>
