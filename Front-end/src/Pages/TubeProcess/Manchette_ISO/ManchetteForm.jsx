...
export default function ManchetteForm() {
  ...
  // Mutation for creating Manchette
  const { mutate: createManchette, isPending: isSubmitting } = useMutation({
    mutationFn: (data) => ManchetteApi.createManchette(data),
    onSuccess: () => {
      toast.success("Manchette créée avec succès");
      form.reset();
      navigate('/manchette');
    },
    onError: (error) => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white rounded-lg shadow-md mt-30">
      <h1 className="text-2xl font-bold mb-8 text-center text-gray-800">Formulaire de Manchette</h1>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Code Manchette</FormLabel>
                  <FormControl>
                    <Input
